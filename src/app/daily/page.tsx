  ...
  return (
    <main className="mx-auto max-w-4xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      {!showFeedback ? <>
        ...
        <div className="mt-6 flex flex-wrap items-center gap-5"><button type="button" onClick={submitAnswer} disabled={!choice} className="inline-flex min-h-11 items-center justify-center rounded-md bg-emerald-600 px-5 py-2 font-semibold text-white disabled:cursor-not-allowed disabled:bg-slate-300">Check Answer</button><GuestAccessLink href="/progress" className="inline-flex min-h-11 items-center font-semibold text-emerald-700 hover:underline">View your progress</GuestAccessLink></div>
      ...
      {showFeedback && <GuestAccessLink href="/progress" className="mt-6 inline-flex min-h-11 items-center text-sm font-semibold text-emerald-700 hover:underline">View your progress</GuestAccessLink>}
    </main>
  );
}
