...
export function DailyPracticeCard() {
  ...
  useEffect(() => {
    const frame = window.requestAnimationFrame(() => {
      const history = readProgressHistory(dataScope); const session = readDailySession(dataScope); const today = localDate();
