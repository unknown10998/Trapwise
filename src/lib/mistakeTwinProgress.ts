...
export function readPatternImpact(scope: DataScope = "guest") { return readFromStorage<PatternImpact | null>(scopedDataKey(scope, key), null); }
export function savePatternImpact(value: PatternImpact, scope: DataScope = "guest") { writeToStorage(scopedDataKey(scope, key), value); }
